...
export default function Countdown() {
    ...
    return(
        ...
        {/*Timer box container*/}
        <div className="bg-white dark:bg-gray-800 shaqow-lg rounded-lg p-8 w-full max-w-md">
            ...
            <div className="flex items-center mb-6">
                ...
                <div className="text-6xl font-bold-gray-800 dark:text-gray-200 mb-8 text-center">
                    {formatTime(timeLeft)}
                </div>
